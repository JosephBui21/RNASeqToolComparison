...
baseline0_0_NOISeq_diff_exp <- nrow(baseline0_0_NOISeq$result.table[baseline0_0_NOISeq$result.table$pvalue < 0.05,])
...
baseline1250_0_NOISeq_diff_exp <- nrow(baseline1250_0_NOISeq$result.table[baseline1250_0_NOISeq$result.table$pvalue < 0.05,])
...
baseline625_625_NOISeq_diff_exp <- nrow(baseline625_625_NOISeq$result.table[baseline625_625_NOISeq$result.table$pvalue < 0.05,])
...
baseline4000_0_NOISeq_diff_exp <- nrow(baseline4000_0_NOISeq$result.table[baseline4000_0_NOISeq$result.table$pvalue < 0.05,])
...
baseline2000_2000_NOISeq_diff_exp <- nrow(baseline2000_2000_NOISeq$result.table[baseline2000_2000_NOISeq$result.table$pvalue < 0.05,])
...
poisson0_0_NOISeq_diff_exp <- nrow(poisson0_0_NOISeq$result.table[poisson0_0_NOISeq$result.table$pvalue < 0.05,])
...
poisson625_625_NOISeq_diff_exp <- nrow(poisson625_625_NOISeq$result.table[poisson625_625_NOISeq$result.table$pvalue < 0.05,])
...
single0_0_NOISeq_diff_exp <- nrow(single0_0_NOISeq$result.table[single0_0_NOISeq$result.table$pvalue < 0.05,])
...
single625_625_NOISeq_diff_exp <- nrow(single625_625_NOISeq$result.table[single625_625_NOISeq$result.table$pvalue < 0.05,])
...
random0_0_NOISeq_diff_exp <- nrow(random0_0_NOISeq$result.table[random0_0_NOISeq$result.table$pvalue < 0.05,])
...
random625_625_NOISeq_diff_exp <- nrow(random625_625_NOISeq$result.table[random625_625_NOISeq$result.table$pvalue < 0.05,])
